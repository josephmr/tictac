...
* [`src/tictac/`](src/tictac/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/tictac/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `tictac` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tictac/config.cljs) defaults to `true` in
...
```clj
(ns tictac.example
  (:require [tictac.config :as config])
